The surface reflectance project contains application source code for producing surface reflectance products.  It currently consists of LEDAPS for Landsats 4-7 and L8SR for Landsat 8.
