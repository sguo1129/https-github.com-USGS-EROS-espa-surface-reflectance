...
c if flagn is set... we start converge to the AOT bounds by dichotomy to increase the accuracy of the retrieval	
	...
	if (iter.gt.0) raot550nm=(raot550nm+aot550nm(iaot-1))/2.
	iband=iband3
	call atmcorlamb2(xts,xtv,xfi,raot550nm,iband,pres,tpres,
     ...
     s       troatm(iband),roslamb,tgo,roatm,ttatmg,satm,xrorayp,
     s       err_msg,retval)
        ros3=roslamb
	iband=iband1
	call atmcorlamb2(xts,xtv,xfi,raot550nm,iband,pres,tpres,
	...
	raot1=raot550nm
	aratio1=ros3/ros1
c	write(6,*) "report ",nit, raot550nm,ros1,ros3,aratio1,pratio
	else
c	write(6,*) "report negative",raot550nm,ros1,ros3
        endif 
	enddo
